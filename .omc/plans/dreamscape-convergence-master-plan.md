...
- **다음 증분(순서)**: ⑦ 디코릴 ⑧ 헤드트래킹/바이노럴 ⑨ ADM ⑩ per-obj EQ. xlsx 권위 룸계약=05.룸엔진+02.세션상태(SpatialSessionState.h 22 room param), per-param 룸 OSC 표는 xlsx에 **없음**(/room/*=mmhoa 고유, superset).
